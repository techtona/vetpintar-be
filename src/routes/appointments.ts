...
router.get('/', validateQuery(appointmentQuerySchema), appointmentController.getAllAppointments);
...
router.patch('/:id/status', validateBody(updateAppointmentStatusSchema), appointmentController.updateAppointmentStatus);
